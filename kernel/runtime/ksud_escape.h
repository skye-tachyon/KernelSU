...
__attribute__((cold)) static noinline void sys_execve_escape_ksud_internal(const char __user **filename_user);
__attribute__((cold)) static noinline void kernel_execve_escape_ksud_internal(void **filename_ptr);
