...
static __always_inline void ksu_adb_root_handle_execve(const char __user **filename_user, void ***envp)
{
...
static __always_inline void ksu_adb_root_handle_execveat(char *filename, void *envp_in)
{
	if (unlikely(ksu_adb_root))
